                ...
                <div className='products__inner'>
                    ...
                    <div className='products__slider-box'>
                        ...
                        <div className='products__slider-btn'>
                            <button className='product__left-btn'><svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.21839 1L1 9L9.21839 17" stroke="white" />
                            </svg>
                            </button>
                            <button className='product__right-btn'><svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
